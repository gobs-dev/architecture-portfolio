...
const whatappLink = "https://wa.me/08123123123";

export default function Home() {
  return (
    <main className="min-h-screen bg-background text-foreground">
      <section className="relative min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <Image
        ...
        />
        <div className="relative z-10 text-center text-primary-foreground max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
            Bangun Rumah Impian <br />
            Anda Sekarang.
          </h1>
          <p className="text-lg sm:text-xl mb-8">
            Desain arsitektur unik untuk hunian & komersial yang memukau. Mulai
            dengan konsultasi gratis!
          </p>
          <Button
            size="lg"
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 md:pl-8">
              ...
              <p className="mb-4 text-muted-foreground">
                With over 20 years of experience and a passion for innovative
                design, our team of certified architects brings your vision to
                life. We believe in creating spaces that inspire, function
                flawlessly, and stand the test of time.
              </p>
              <p className="text-muted-foreground">
                Our mission is to deliver exceptional architectural solutions
                that exceed our clients' expectations, combining creativity,
                sustainability, and cutting-edge technology in every project we
                undertake.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <Tabs defaultValue="all" className="w-full">
            ...
            >
              {["Residential", "Commercial", "Interior"].map(
                (category, index) => (
                  <Card key={index} className="overflow-hidden">
                    <Image
                      src={`https://placehold.co/400x300.webp?text=${category}`}
                    ...
                    <CardContent className="p-4">
                      <CardTitle className="text-foreground pb-2">
                        {category} Project {index + 1}
                      </CardTitle>
                      <CardDescription>Location: City, Country</CardDescription>
                    </CardContent>
                  </Card>
                )
              )}
      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: "Custom Home Design", icon: "🏠" },
              { title: "Commercial Building Planning", icon: "🏢" },
